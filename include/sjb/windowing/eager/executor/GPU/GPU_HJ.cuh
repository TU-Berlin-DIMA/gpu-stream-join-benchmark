#ifndef STREAMJOINBENCHMARK_EAGER_GPU_HJ_CUH
#define STREAMJOINBENCHMARK_EAGER_GPU_HJ_CUH
...
namespace Windowing {
    namespace Eager {
        namespace Executor {
            class GPU_HJ : public BaseEagerExecutor {
            public:
                GPU_HJ(uint64_t numDistinctKeys, uint64_t windowSize, uint64_t batchSize);
            ...
            private:
                 ...
                 * @param hashTableOccupation a pointer to an array storing the occupation of the hashtable
                 */
                uint64_t probeHashTable(Tuple *tuples, Tuple *hashTable, uint32_t *hashTableOccupation);
...
#endif //STREAMJOINBENCHMARK_EAGER_GPU_HJ_CUH
