...
namespace Windowing {
    namespace Lazy {
        namespace Executor {
            GPU_HJ_NoOutput::GPU_HJ_NoOutput(
            ...
            ExecutionStatistic GPU_HJ_NoOutput::execute(Tuple *leftRingBuffer, Tuple *rightRingBuffer,
            ...
            GPU_HJ_NoOutput::~GPU_HJ_NoOutput() = default;
        }
    }
}